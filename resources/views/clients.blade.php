                                            ...
                                            @if(isset($clients))
                                                @foreach($clients as $client)
                                                    <tr>
                                                        ...
                                                        <td><a data-toggle="tab" rel="{{$client->id}}" href="#contact-{{$client->id}}" class="client-link">{{$client->LastName}} {{$client->FirstName}}</a></td>
                                                        <td class="contact-type"><i class="fa fa-phone"> </i></td>
                                                        <td> {{$client->Mobile}}</td>
                                                        <td class="contact-type"><i class="fa fa-envelope"> </i></td>
                                                        <td> {{$client->Email}}</td>
                                                        <td style="vertical-align:middle;"><a href="" class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></a></td>
                                                    </tr>
                                                @endforeach
            ...
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <div class="tab-content">
                        @if(isset($clients))
                            @foreach($clients as $client)
                                <div id="contact-{{$client->id}}" class="tab-pane">
                                    <div class="row m-b-lg">
                                        <div class="col-lg-4 text-center">
                                            <h2>{{$client->LastName}} {{$client->FirstName}}</h2>

                                            <div class="m-b-sm">
                                                <img alt="image" class="img-circle" src="img/img_generic_person.jpg" style="width: 62px">
                                            </div>
                                        </div>
                                        <div class="col-lg-8">
                                            <strong>
                                            ...
                                            <a type="button" class="btn btn-primary btn-sm btn-block" href="mailto:{{$client->Email}}?subject=ATS Repair Center&amp;body=Bonjour"><i class="fa fa-envelope"></i> Mail
                                            </a>
                                            <button class="btn btn-warning btn-sm btn-block"><i class="fa fa-pencil"></i> Editer</button>
                                        </div>
                                    </div>
